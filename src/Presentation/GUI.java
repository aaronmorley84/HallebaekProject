/*//GEN-FIRST:event_OrderProductSearchButtonActionPerformed
 * To change this template, choose Tools | Templates//GEN-LAST:event_OrderProductSearchButtonActionPerformed
...
public class GUI extends javax.swing.JFrame {
    ...
    private void MainNavDropActionPerformed(java.awt.event.ActionEvent evt) {                                            
        selectPanel(2);
    }                                           

    private void ExitDropActionPerformed(java.awt.event.ActionEvent evt) {                                         
        System.exit(0);
    }                                        
    ...
    private void OrderMenuButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                
        selectPanel(8);
        CreateOrderButton.setEnabled(false);
    }                                               

    private void CustNavDropActionPerformed(java.awt.event.ActionEvent evt) {                                            
        selectPanel(3);
        AddCustomerButton.setEnabled(true);
        AddEditPhoneButton.setEnabled(false);
        DeleteCustomerbutton.setEnabled(false);
    ...
    private void OrdNavDropActionPerformed(java.awt.event.ActionEvent evt) {                                           
        selectPanel(5);
    }                                          

    private void ProductMenuButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        selectPanel(4);
        clearProductFields();
    ...
    private void ProdNavDropActionPerformed(java.awt.event.ActionEvent evt) {                                            
        selectPanel(4);
        clearProductFields();
        AddProductButton.setEnabled(true);
        DeleteProductButton.setEnabled(false);
    ...
    private void GetCustomerButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        model1.clear();
    ...
    private void SaveCustomerChangeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
    ...
    private void GetProductsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void SaveProductChangesButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
    ...
    private void SearchForProductIDButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        con.clearProductList();
        con.buildProductList();
    ...
    private void OrdergetAllProductsButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                          
        con.clearProductList();
        con.buildProductList();
        int counter = 0;
        model3.clear();
    ...
    private void OrderAddProductToOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                             
    ...
    private void OrderRemoveFromOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                           
...
//        }
    ...
    private void OrderSaveOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                     
    ...
    private void PackageMenuButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        selectPanel(6);
        clearPackageFields();
        AddPackageButton.setEnabled(true);
        EditPackProdButton.setEnabled(false);
    ...
    private void PackNavDropActionPerformed(java.awt.event.ActionEvent evt) {                                            
        selectPanel(6);
        clearPackageFields();
        AddPackageButton.setEnabled(true);
        EditPackProdButton.setEnabled(false);
    ...
    private void PackageNameFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        // TODO add your handling code here:
    }                                                

    private void ExistingPackageButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        model7.clear();
    ...
    private void EditPackageButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void OrderSearchProductButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                                          
    ...
    private void EditPackProdButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        selectPanel(7);
        model5.clear();
    ...
    private void AddProductToPackageButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                          
...
//        }
    ...
    private void RemoveFromPackageButtoActionPerformed(java.awt.event.ActionEvent evt) {                                                       
...
//        model5.removeElement(prodForRemoval);
    ...
    private void PackageNameField2ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // TODO add your handling code here:
    }                                                 
    ...
    private void DeletePackageButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        con.deletePackageProducts();
        con.deletePackage();
    ...
    private void LogOutDropActionPerformed(java.awt.event.ActionEvent evt) {                                           
        selectPanel(1);
        NavigationDropMenu.setEnabled(false);
        AdminDropMenu.setEnabled(false);
        AdminDropMenu.setEnabled(false);
    ...
    private void ProductNameSearchFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        // TODO add your handling code here:
    }                                                      

    private void SearchForProductNameButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        con.clearProductList();
        con.buildProductList();
    ...
    private void GetCustomersButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        model8.clear();
    ...
    private void AddCutomerToOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    private void OrderCustomerIDFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        // TODO add your handling code here:
    }                                                    

    private void OrderTrucksNeededFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        // TODO add your handling code here:
    }                                                      

    private void GetAvailableTrucksButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        model9.clear();
    ...
    private void PickUpOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void TruckOrderButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void OrderIDFieldActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void OrderProductSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        con.clearProductList();
        con.buildProductList();
